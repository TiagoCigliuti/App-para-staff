...
import { ArrowLeft, Building, Save, Upload, Trash2, AlertTriangle } from "lucide-react"
...
export default function EditarCliente({ clienteId }: { clienteId: string }) {
  ...
  useEffect(() => {
    const fetchClienteData = async () => {
      try {
        const docRef = doc(db, "clients", clienteId)
        ...
        setStatus(data.activo !== undefined ? (data.activo ? "active" : "inactive") : "active")
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="border border-red-200 shadow-sm">
            <CardContent className="p-6 text-center">
              ...
              <h2 className="text-xl font-medium text-gray-900 mb-2">Cliente no encontrado</h2>
              <p className="text-gray-600 mb-6">El cliente que intentas editar no existe o ha sido eliminado.</p>
              <Button
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-medium text-gray-800 mb-8">Editar cliente</h1>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        ...
                        <span className="font-semibold"> {name}</span> y todos sus datos asociados.
                      </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
